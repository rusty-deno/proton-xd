...
export const lib = Deno.dlopen(bindingsUri, {
  ...
  outer_size: { parameters: ["usize"], result: "buffer", nonblocking: false },
  ...
  request_redraw: { parameters: ["usize"], result: "void", nonblocking: false },
...
export function request_user_attention(a0: bigint, a1: string) {
  ...
  const rawResult = symbols.request_user_attention(
    a0,
    a1_buf,
    a1_buf.byteLength,
  );
